import{d,i as p,a as _,u,b as h,c as m,e as f,f as n,g as t,t as s,h as a,F as g,r as v,n as x,j as y,o as r,k as b,l as N,m as k,p as P,q as w,_ as S}from"./index-f09f120f.js";import{N as V}from"./NoteDisplay-73cd01e6.js";const j={class:"m-4"},D={class:"mb-10"},L={class:"text-4xl font-bold mt-2"},T={class:"opacity-50"},z={class:"text-lg"},B={class:"font-bold flex gap-2"},C={class:"opacity-50"},E=t("div",{class:"flex-auto"},null,-1),H={key:0,class:"border-gray-400/50 mb-8"},F=d({__name:"PresenterPrint",setup(M){p(_),u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
